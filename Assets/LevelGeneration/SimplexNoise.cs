...
namespace Simplex {
    ...
    /// </summary>
    public class Noise {
        public static float[] Calc1D(int width, float scale, float[] values = null) {
            if (values == null)
        ...
        public static float[,] Calc2D(int width, int height, float scale, float[,] values = null) {
            if (values == null)
        ...
        public static float[,,] Calc3D(int width, int height, int length, float scale, float[,,] values = null) {
            if (values == null)
                values = new float[width, height, length];
            for (int i = 0; i < width; i++)
                for (int j = 0; j < height; j++)
